...
#cd freetype-2.11.0 && ./guangbin-build-r15-armeabi-v7a.sh && cd ..
...
cd curl-7.32.0 && ./guangbin-build-r15-armeabi-v7a.sh && cd ..
...
cd gdal-2.4.0 && ./guangbin-build-r15-armeabi-v7a.sh && cd ..
